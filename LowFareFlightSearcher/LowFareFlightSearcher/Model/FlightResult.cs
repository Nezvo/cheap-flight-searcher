...
{
	[Serializable]
	public class FlightResult : NotifyPropertyChanged
	{
		...
		public int ConnectingFlightsOutboundCount
		{
			get { return _connectingFlightsOutboundCount; }
			set
			{
				_connectingFlightsOutboundCount = value;
				Notify();
			}
		}

		public int ConnectingFlightsInboundCount
		{
			get { return _connectingFlightsInboundCount; }
			set
			{
				_connectingFlightsInboundCount = value;
				Notify();
			}
		}
